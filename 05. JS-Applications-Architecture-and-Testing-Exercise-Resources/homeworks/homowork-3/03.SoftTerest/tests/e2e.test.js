...
// Application host (NOT service host - that can be anything)
const DEBUG = false;

let route = 'http://localhost:63342/js-applications/05.%20JS-Applications-Architecture-and-Testing-Exercise-Resources/homeworks/homowork-3/03.SoftTerest/index.html?_ijt=75a9gaup2d9nse83ucfrf2t8pv';
const host = route;
