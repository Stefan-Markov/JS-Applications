...
export let allBooksTemplate = (books, editHandler) => html`${books.map(b => bookTemplate(b, editHandler))}`;

export let tableTemplate = (books, editHandler) => html`
    <table>
        <thead>
        <tr>
            <th>Title</th>
...
export let bookLibaryTemplate = (books, forms, loadBooksHandler, editHandler) => html`
